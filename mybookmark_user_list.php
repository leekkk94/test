			...
			<section class="page-header page-header-xs">
				<div class="container text-center">
					...
					<ul class="page-header-tabs list-inline">
						<li class="active"><a href="<?php echo TR_URL; ?>/mybookmark_user_list.php">북마크한 채용정보</a></li>
						<li><a href="<?php echo TR_URL; ?>/sentresume_list.php">제출한 이력서</a></li>
			...
			<div class="inner-wrap">
				...
				<div class="container">
					<section class="section-box">
				        ...
				        <h4>북마크한 채용정보<span>총 11건</span></h4>
							</div>
		              ...
		              <select class="form-control">
						...
						<div class="search-result-item2">
							...
							<div class="btn-area">
								<a href="#" class="btn btn-primary btn-xs">이력서 제출</a>
